...
.campo-busca {
   display: flex;
   align-items: center;
   width: min(100%, 380px); min-height: 44px;
   padding: 0 0.9rem;
...
.favorito-card {
  ...
  ; background: rgba(255, 255, 255, 0.9);
   box-shadow: 0 10px 26px rgba(28, 28, 34, 0.05);
 }
.card-topo, .card-rodape {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 0.75rem;
...
.sigla {
  ...
  border-radius: 8px; background: var(--brand-700);
  color: var(--white);
  font-size: 0.72rem; font-weight: 800;
 }
.remover { width: 34px; height: 34px;
...
.localizacao {
   margin: 0; color: var(--ink-500); font-size: 0.8rem; }
.card-rodape {
   margin-top: auto;
   padding-top: 1.1rem;
  border-top: 1px solid rgba(28, 28, 34, 0.07)
  ;
 }
.tag {
   padding: 0.25rem 0.45rem;
   border-radius: 4px;
   background: var(--cream-100); color: var(--ink-600); font-size: 0.68rem;
 }
.detalhes {
   color: var(--brand-700);
   font-size: 0.78rem;
...
.estado-vazio { display: flex; min-height: 250px; align-items: center; justify-content: center; flex-direction: column; padding: 2rem; border: 1px dashed rgba(28, 28, 34, 0.15); border-radius: 16px;
   background: rgba(255, 255, 255, 0.55);
   text-align: center;
 }
.icone-vazio { display: grid; width: 48px; height: 48px; place-items: center; margin-bottom: 1rem; border-radius: 12px; background: var(--cream-200);
   color: var(--brand-600); font-size: 1.8rem;
 }
