    ...
    <div class="favoritos-container">
      ...
      <div v-else class="estado-vazio">
        ...
        <p>
          {{
            busca
              ? 'Tente buscar pelo nome ou limpe o filtro.'
              : 'Toque no coração nos cards ou no perfil da universidade para salvar aqui.'
          }}
        </p>
        <button v-if="busca" class="botao-secundario" type="button" @click="busca = ''">
          Limpar busca
        </button>
        <RouterLink v-else to="/universidades" class="botao-primario"
...
.estado-vazio {
  ...
  flex-direction: column;
  padding: 2rem;
  border: 1px dashed rgba(28, 28, 34, 0.15);
  border-radius: 16px;
